...
- Fix the in-document advertising styles. ([e4b5026](https://github.com/vuejs/vitepress/commit/e4b50260607193af8cf67c07e81833e63f696067))
...
- 修改 ([8815906](https://github.com/vuejs/vitepress/commit/8815906be1dd3531d3e3e3bd9482a91aa8872f32))
...
- **build:** force assets to go through vite pipeline during dev too ([#3258](https://github.com/vuejs/vitepress/issues/3258)) ([c3d7f22](https://github.com/vuejs/vitepress/commit/c3d7f22bd313b09e6965ac3125ea662ce283ed2d))
...
- **build:** resolve patter relative to srcDir instead of root in createContentLoader ([#3638](https://github.com/vuejs/vitepress/issues/3638)) ([59183e9](https://github.com/vuejs/vitepress/commit/59183e9cef112a004c8a8e2b365478af657858b0))
...
- **build:** respect srcExclude in content loader ([#2963](https://github.com/vuejs/vitepress/issues/2963)) ([3023b5c](https://github.com/vuejs/vitepress/commit/3023b5c76be50da1cb8837ac93671d5288b863f2))
...
- **build:** use vue dev build when DEBUG is truthy ([#2622](https://github.com/vuejs/vitepress/issues/2622)) ([2c25855](https://github.com/vuejs/vitepress/commit/2c25855986a59eff1d5c09b50b934da7cf407912))
...
- change package name ([a235846](https://github.com/vuejs/vitepress/commit/a2358464e1b4de3c45a898f92739f7c329b7101f))
...
- **deps:** bundle vite-plugin-vue - two vite versions being installed ([cecc47d](https://github.com/vuejs/vitepress/commit/cecc47da11bd524df70e58207f617f61c2057f29))
...
- enter key behavior conflict with IME in search box ([#3454](https://github.com/vuejs/vitepress/issues/3454)) ([cd8ee6f](https://github.com/vuejs/vitepress/commit/cd8ee6fb32d8135e78c5827a36b79efad509042c))
...
- fallback to textContent while copying code ([bdfc01c](https://github.com/vuejs/vitepress/commit/bdfc01c9ec3b138facad999bde0354ef44cd05a3))
...
- Fixed code style ([0d96620](https://github.com/vuejs/vitepress/commit/0d96620409881de479dedab5c7323040b761bdba))
...
- merge bundledLanguages with user provided languages for less breakage ([33ce7e4](https://github.com/vuejs/vitepress/commit/33ce7e44783ebf3281d5ff2bac93c0fba07d709d))
...
- remove index.html when using createContentLoader ([#2693](https://github.com/vuejs/vitepress/issues/2693)) ([6fc88a5](https://github.com/vuejs/vitepress/commit/6fc88a5cce431fa47330860155191f7b3eccb62e))
...
- respect empty rel and target ([#2705](https://github.com/vuejs/vitepress/issues/2705)) ([60dd0a4](https://github.com/vuejs/vitepress/commit/60dd0a474b056ec884f3173a233f1fb951d96870))
...
- **router:** hashchange not emitted in certain cases ([#3637](https://github.com/vuejs/vitepress/issues/3637)) ([6b971a0](https://github.com/vuejs/vitepress/commit/6b971a08f5ee1593dcda6252835b5404db87c2f8))
...
- **style:** incorrect header anchor icon position with multline headers ([#2694](https://github.com/vuejs/vitepress/issues/2694)) ([77c1b4d](https://github.com/vuejs/vitepress/commit/77c1b4d3cd3c47ffc5268ac24d0f983df443075d))
...
- **theme:** fix sidebar collapsing and restore base property ([#2753](https://github.com/vuejs/vitepress/issues/2753)) ([9a4ee07](https://github.com/vuejs/vitepress/commit/9a4ee07260191adeb4c3810d95b044439609525c))
...
- **theme:** remove extra offset ([3f6ca6a](https://github.com/vuejs/vitepress/commit/3f6ca6a37461b5cbe5a0201799e5b11b8b8c860d))
...
- **types:** export duplicate type `Sidebar` ([#2573](https://github.com/vuejs/vitepress/issues/2573)) ([a99dcf9](https://github.com/vuejs/vitepress/commit/a99dcf94436d6cbbd53ef5481a6ec5ffd8d887d2))
...
- add `window.__VITEPRESS__` ([#3634](https://github.com/vuejs/vitepress/issues/3634)) ([f6bd99e](https://github.com/vuejs/vitepress/commit/f6bd99eb1311238e1114301a767634b139327916))
...
- expose **path and **relativePath on md instance for md plugins ([4cec660](https://github.com/vuejs/vitepress/commit/4cec660401d8d01830e5a11b9c66bc0ac5a935db))
...
- migrate to shikiji ([#3237](https://github.com/vuejs/vitepress/issues/3237)) ([75f18e4](https://github.com/vuejs/vitepress/commit/75f18e47334933b642d14b8b69b372cb1ebd4244))
...
- rel for feature links ([#2704](https://github.com/vuejs/vitepress/issues/2704)) ([5d18fd8](https://github.com/vuejs/vitepress/commit/5d18fd8978e418ce920aab357b180a58b1af3077))
...
- Support in-document advertising. ([ca478f1](https://github.com/vuejs/vitepress/commit/ca478f19b138166a6bf5b71e7a7764880bb1f35d))
...
- Revert "fix(build): respect srcExclude in content loader" (#2975) ([76e9fe8](https://github.com/vuejs/vitepress/commit/76e9fe86b2312c58cfa9d392b11e4e36e6afb676)), closes [#2975](https://github.com/vuejs/vitepress/issues/2975) [#2963](https://github.com/vuejs/vitepress/issues/2963)
...
- **#2622:** to fix hmr ([ec6bfbd](https://github.com/vuejs/vitepress/commit/ec6bfbd5a3bfe094ba9e249f1982dc7d760de98a))
...
- back to vite 4 ([7fabfc5](https://github.com/vuejs/vitepress/commit/7fabfc513a0b7edd6a5a2ac762eeddf6eddb84d9))
...
- **theme:** revert 'allow setting base path in sidebar items' ([2fe8f60](https://github.com/vuejs/vitepress/commit/2fe8f60681793cb406100827ff34e0714f523d37)), closes [#2752](https://github.com/vuejs/vitepress/issues/2752)
- types for internal internal components ([e703429](https://github.com/vuejs/vitepress/commit/e7034294731493a198cdd4789198f1c94f21b181))
...
- reverts the breaking changes in beta-2
